...
class MultiHeadSelfAttention(nn.Module):
	...
	def forward(self, x: Tensor, tok_mask: Tensor):
		...
		# apply attention
		y = nn.functional.scaled_dot_product_attention(q, k, v, key_padding_mask=~tok_mask, dropout=self.p_dropout, is_causal=self.is_causal)
		# combine heads
...
class MultiHeadCrossAttention(nn.Module):
	...
	def forward(self, x_q: Tensor, x_kv: Tensor, q_tok_mask: Tensor, kv_tok_mask: Tensor):
		...
		# apply attention
		y = nn.functional.scaled_dot_product_attention(q, k, v, key_padding_mask=~kv_tok_mask, dropout=self.p_dropout)
		# combine heads
