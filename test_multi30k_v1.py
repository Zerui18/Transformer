...
def main():
	...
	# web UI for watching/managing the sweep; blocks until Ctrl-C
	serve(exp_manager)

# the __main__ guard is REQUIRED: on spawn platforms (macOS/Windows) every child
# process re-imports this script, and unguarded top-level enqueueing would fork-bomb
