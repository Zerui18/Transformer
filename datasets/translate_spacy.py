...
def yield_tokens(data_iter: Iterable, language: str) -> List[str]:
    ...
    for data_sample in data_iter:
        yield TranslationDatasetSpacy.token_transform[language](data_sample[language_index[language]])
...
class TranslationDatasetSpacy(BaseDataset):
    ...
    def __init__(self, config: TranslationDatasetSpacyConfig):
        TranslationDatasetSpacy._init_resources()
        super().__init__()
    ...
    @staticmethod
    def _init_resources():
        if TranslationDatasetSpacy._INIT_RESOURCES_DONE:
            return
        ...
        TranslationDatasetSpacy.token_transform = token_transform
        ...
        TranslationDatasetSpacy.vocab_transform = vocab_transform
        ...
        TranslationDatasetSpacy.text_transform = text_transform
        TranslationDatasetSpacy._INIT_RESOURCES_DONE = True
    ...
    def __getitem__(self, idx):
        ...
        src = TranslationDatasetSpacy.text_transform['de'](src.rstrip("\n"))
        dst = TranslationDatasetSpacy.text_transform['en'](dst.rstrip("\n"))
        return src, dst
